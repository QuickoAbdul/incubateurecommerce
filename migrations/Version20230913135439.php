 ...
 */
final class Version20230913135439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD numberphone INT NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP numberphone, CHANGE email email VARCHAR(120) NOT NULL');
    }
}
